...
- **Rutinas** — crea rutinas con series/reps/descanso objetivo por ejercicio, en el orden que quieras, con día fijo opcional. Puedes construirlas tú a mano o pulsar **🤖 Generar** para que la app te proponga un programa completo (full body, torso/pierna, empuje-tirón-pierna...) según tu objetivo, nivel, días por semana y equipo disponible — y luego cambiar cualquier ejercicio propuesto por otro similar con el botón 🔄, antes o después de guardarlo.
...
└── js/
    ...
    ├── generator.js         # genera programas tipo "entrenador" y busca alternativas de ejercicio
    ├── swap.js              # picker de "🔄 cambiar ejercicio" (usado en rutinas manuales y generadas)
